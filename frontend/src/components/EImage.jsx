  ...
  return (
    <section className="relative">
      ...
      <div
        ...
        data-aos-duration="300"
        className="absolute right-5 top-5 flex items-center gap-2 bg-white dark:bg-black text-black dark:text-white rounded-full p-1 pr-3 md:p-2 md:pr-5"
      >
        <TbPhoneCall
          data-aos="zoom-in"
          data-delay-duration="200"
          data-aos-duration="300"
          className="bg-black text-white dark:bg-white dark:text-black w-6 h-6 p-1 rounded-full  motion-preset-pulse motion-duration-1500 motion-scale-in-50"
        />
      ...
      >
        <img
          className="w-8 h-8 md:w-12 md:h-12 object-cover object-top rounded-full group-hover:scale-105 duration-300 border-2 border-black dark:border-white"
