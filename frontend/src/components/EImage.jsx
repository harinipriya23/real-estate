  ...
  return (
    <section className="relative">
      ...
      <div
        ...
        data-aos-duration="300"
        className="absolute group right-5 top-5 flex items-center gap-2 bg-white dark:bg-black text-black dark:text-white rounded-full p-1 pr-3 md:p-2 md:pr-6"
      >
        <TbPhoneCall
          data-aos="zoom-in"
          data-delay-duration="200"
          data-aos-duration="300"
          className="bg-neutral-700 text-white dark:bg-white dark:text-black group-hover:scale-105 duration-300 w-6 h-6 md:w-8 md:h-8 p-1 rounded-full"
        />
        <span className="text-[12px] md:text-[18px] xl:text-[16px]">
          Call us now
        </span>
      </div>
      <div
      ...
      >
        <img
          className="w-8 h-8 md:w-12 md:h-12 object-cover object-top rounded-full group-hover:scale-105 duration-300 border-2 border-neutral-700 dark:border-white"
