...
export const CallButton = () => {
  return (
    <div className="inline-flex md:my-2 items-center gap-2 bg-black dark:bg-white text-white dark:text-black rounded-full p-1 pr-3 md:p-2 md:pr-5 motion-preset-slide-right-md motion-duration-1500">
