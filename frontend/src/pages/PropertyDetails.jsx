        ...
        <section className="h-full w-full p-4 bg-neutral-200 text-black dark:bg-neutral-900 dark:text-neutral-100">
            <div className="grid grid-cols-1 md:grid-cols-10 w-full bg-white dark:bg-neutral-800 rounded-2xl shadow-lg p-6 md:p-10 font-inter">
                <div className="relative col-span-4">
                    ...
                    />
                    <span className="absolute top-5 right-5" ><CallButton /></span>
                ...
                <div className="col-span-6 md:pl-10">
                    <h2 className="text-xl md:text-2xl lg:text-3xl mt-2 font-bold text-center">
                    ...
                    <div className="space-y-4"> <div className="my-4">
                        ...
                        <div className="flex flex-wrap p-2 md:px-4 gap-2 font-semibold text-sm md:text-base ">
                        ...
                        <div className="my-4">
                            ...
                            <div className="flex flex-col p-2 md:px-4 font-semibold text-sm md:text-base ">
                                <div>
                                    Landmarks:
