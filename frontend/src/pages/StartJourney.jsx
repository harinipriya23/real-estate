    ...
    <section className="w-full p-4 bg-neutral-100 dark:bg-neutral-800">
      <div className="relative w-full max-h-screen rounded-lg overflow-hidden">
        ...
        >
          ...
          <button
            className="bg-white text-black  py-1 px-2 lg:py-2 lg:px-4 rounded-md font-medium text-sm md:text-base
          overflow-hidden transition-all duration-500 hover:scale-95 hover:bg-black hover:text-white"
          >
            Start Your Journey
          </button>
        </div>
